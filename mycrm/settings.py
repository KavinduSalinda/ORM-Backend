...
SECRET_KEY = 'django-insecure-c1+r@4l+9#fm5%w0o+n@v#y0gnk_o#uc36*u^g!b43u=hdbc_b'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mycrm',           # Your database name
        'USER': 'root',              # Your MySQL user
        'PASSWORD': 'Kavindu20171#',      # Your MySQL user's password
